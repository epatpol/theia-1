...
// import { PreferenceServerImpl } from '../json-preference-server';
...
//         return new PreferenceServerImpl(this.fileSystem, this.fileWatcher, this.logger, Promise.resolve(preferenceFileUri));
//     }
