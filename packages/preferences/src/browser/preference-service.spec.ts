...
import { FileSystemWatcher, FileSystem, FileChange, } from '@theia/filesystem/lib/common/';
import { FileSystemWatcherServer } from '@theia/filesystem/lib/common/filesystem-watcher-protocol';
import { ILogger } from '@theia/core/lib/common/logger';
import { PreferenceProviderUser, PreferenceProviderWorkspace } from './';
...
before(async () => {
    ...
    /* Preference bindings*/
    testContainer.bind(PreferenceProviderUser).toSelf();
    testContainer.bind(PreferenceProviderWorkspace).toSelf();
